export default function LabelInput( {label, invalid, ...props} ) {
  ...
  if ( invalid ) {
    ...
    inputClasses = "w-full px-3 py-2 leading-tight text-red-500 border rounded shadow bg-red-100 border-red-300";
  }
  return (
    <p> 
